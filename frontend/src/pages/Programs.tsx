...
const programsData: ProgramDetail[] = [
  {
    ...
    features: [
      ...
      'Custom macro & nutrition guidelines',
  ...
  {
    id: 'nutrition',
    badge: 'Lifestyle & Fuel',
    title: 'Nutrition & Macro Strategy',
    tagline: 'Fuel performance without restrictive fad diets.',
    description: 'Data-backed nutrition protocols focused on sustainable habits, energetic performance, body recomposition, and long-term health.',
    price: '$149',
    period: '/ month',
    features: [
      'Customized macronutrient distribution',
      'Grocery list & meal structure templates',
      'Weekly metabolic & body composition audit',
      'Supplementation recommendations',
      'Event & travel eating strategies',
    ],
  },
];
